...
public class MwJpiBuilderTest {
    ...
    public void testConfigRoundtrip() throws Exception {
        ...
        project.getBuildersList().add(new Builder(name));
        project = jenkins.configRoundtrip(project);
        jenkins.assertEqualDataBoundBeans(new Builder(name), project.getBuildersList().get(0));
    }
